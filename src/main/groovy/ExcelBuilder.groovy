...
/** * Groovy Builder that extracts data from * Microsoft Excel spreadsheets. * @author Goran Ehrsson */
class ExcelBuilder {
    def workbook
    def labels
        ...
        HSSFRow.metaClass.getAt = { int idx ->
            ...
            switch (cell.cellType) {
                case HSSFCell.CELL_TYPE_NUMERIC: if (HSSFDateUtil.isCellDateFormatted(cell)) {
                    ...
                    break case HSSFCell.CELL_TYPE_BOOLEAN: value = cell.booleanCellValue
                break default: value = cell.stringCellValue
                break
            }
            return value
        }
